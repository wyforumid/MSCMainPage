...
module.exports = function authenticate(passport, name, options, callback) {
  ...
  return function authenticate(req, res, next) {
    ...
    function allFailed() {
      if (callback) {
        if (!multi) {
          return callback(req, res, failures[0].challenge, failures[0].status, null, false);
        } else {
          ...
          return callback(req, res, null, false, challenges, statuses);
        }
      }
    ...
    (function attempt(i) {
      ...
      strategy.success = function(user, info) {
        if (callback) {
          return callback(req, res, user, info);
        }
